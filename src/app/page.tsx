...
const selects = [
  ...
  },
  {
    ...
    type: "Historical Arts Documentary",
    reason: "Selected for institutional archival rigor, verified festival traction, and regional civic impact screening demand.",
    color: "coral",
    href: "/projects/american-pachuco",
    status: "Published Scout Card · verified core evidence",
  },
  {
    title: "The Vampair Series",
    type: "Independent Animated Musical",
