...
**Audience Take** is an autonomous intelligence and scouting platform designed to bridge the chasm between grassroots independent screen projects (YouTube pilots, crowdfunding campaigns, animated shorts, indie series, proof-of-concepts) and institutional entertainment buyers.

Traditional development pipelines fail because:
1. **The "Goodreads / Echo-Chamber" Problem**: Vocal online fanbases brigade platforms, inflating niche projects while commercially viable gems go unnoticed.
2. **The "Static Card / Data Decay" Trap**: Hollywood moves slowly while indie creators move rapidly. Static databases become obsolete within months.

Audience Take solves both problems through **Autonomous Agent Intelligence**, **Multimodal Video Understanding**, **YouTube Comment NLP**, and a rigorous **Dual-Axis Market Viability Index**.
...
```
┌──────────────────────────────────────────────────────────────────────────────────────────┐
│  SCOUT CARD HEADER STATUS STACK                                                          │
│  [ Structure: complete ]  [ Evidence: Core verified ]  [ Heat: 98/100 ]  [ Viability: 90/100 ] │
└──────────────────────────────────────────────────────────────────────────────────────────┘
                                             │
┌──────────────────────────────────────────────────────────────────────────────────────────┐
│  DUAL-AXIS INDEX & BUYER DECISION MATRIX                                                 │
│  ├─ Grassroots Momentum: Audience Heat 98/100 (High Velocity & Crowdfunding Backing)     │
...
└──────────────────────────────────────────────────────────────────────────────────────────┘
                                             │
┌──────────────────────────────────────────────────────────────────────────────────────────┐
│  YOUTUBE FANDOM DNA & AUDIENCE RESONANCE (GEMINI 3.5 FLASH NLP)                          │
│  ┌───────────────────────┬───────────────────────┬───────────────────────┬─────────────┐ │
│  │ Community Obsessions  │ Merch Propensity      │ Critical Reception    │ Fandom Comps│ │
│  │ • Duke & Missi rivalry│ • Vinyl OST requests  │ • Broadway-level score│ • Hazbin    │ │
│  │ • Ballroom lighting   │ • Artbook tier pledges│ • Pacing praise       │ • Lackadaisy│ │
│  │ • 2D choreography     │ • Character plushies  │ • Backstory note      │ • Castlevania││
│  └───────────────────────┴───────────────────────┴───────────────────────┴─────────────┘ │
│  • Anti-Brigade Verdict: Genuine high-yield cult engagement with €64.19/backer ARPU.     │
└──────────────────────────────────────────────────────────────────────────────────────────┘
```

### 1. The Dual-Axis Scoring System (Anti-Goodreads Sanity Check)
Decouples **Grassroots Momentum** from **Institutional Buyer Viability**:
- **Audience Heat (0–100)**: Measures velocity using logarithmic view scaling, like-to-view ratios, crowdfunding overfunding percentages, and backer discretionary spend ARPU.
- **Market Viability (0–100)**: Bounded buyer sanity check:
  - `30%` Cross-Platform Trade Diffusion (*Animation Magazine*, *C21Media*, *Variety*)
  - `25%` Budget-to-Format Unit Cost Realism (€18k–€25k/min for 2D animation vs available capital + studio attachment)
...
```bash
git clone https://github.com/tmoody1973/audience-take-gemini.git
cd audience-take-gemini
npm install
```
...
npm run dev
```
Open [http://localhost:3000](http://localhost:3000) to view the Public Scouting Wall.
